...
public class EasyFlow : IEasyFlow
{
	...
	private void DeployProjectInternal(bool isSelfDeploy, string proejctPath, string sqlConnectionString, DeployParameters parameters)
	{
		...
		ExecuteWithinTransaction(
			...
			() =>
			{
				DeployMigrations(isSelfDeploy, sqlConnectionString, parameters);

				DeployCode(isSelfDeploy, sqlConnectionString, parameters);

				DeployBreakingChanges(sqlConnectionString, parameters);
			}
		);
	...
	private void DeployBreakingChanges(string sqlConnectionString, DeployParameters parameters)
	{
	...
	private void DeployMigrations(bool isSelfDeploy, string sqlConnectionString, DeployParameters parameters)
	{
