...
public class MyXunitTestCase : TestMethodTestCase, IXunitTestCase
{
	...
	public MyXunitTestCase(IMessageSink diagnosticMessageSink,
	...
	protected override void Initialize()
	{
		...
		{
			InitializationException = new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, "Exception during initialization:{0}{1}", Environment.NewLine, ex.ToString()));
		}
	}
